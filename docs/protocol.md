...
|   2 | VirtualList | `[2,itemCount,rangeStart,rangeEnd,estimatedItemSize,overscan]`; counts/ranges/overscan are u32, `rangeStart <= rangeEnd <= itemCount`, and estimated size is finite and positive.                                                                                                 | `protocol.ts:97,396-412`; `wire/node.rs:59-60,331-348,506-529`; `tree.rs:1020-1031`    |
