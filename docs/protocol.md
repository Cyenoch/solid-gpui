...
| ------------------------ | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Snapshot `[6]`           | array of Node tuples                                                                      | Complete node set. Each node has ten required fields and may carry an optional `selectable=true` tail; shape and parent/child relationship are validated by the retained tree. | `protocol.rs:81`; `tree.rs:215-303; tree/validation.rs:81-229,231-273`                                |
...
and parent-child shape (`tree/validation.rs:81-229,231-273`). For a Text node with
