...
pub use protocol::{
    ...
    MenuAction, MenuDefinition, MenuItemDefinition, Node, PATCH_MESSAGE, POINTER_BUTTON_BACK,
    POINTER_BUTTON_FORWARD, POINTER_BUTTON_LEFT, POINTER_BUTTON_MIDDLE, POINTER_BUTTON_RIGHT,
    PROTOCOL_VERSION, Patch, PatchOperation, PointerEvent, ProtocolError, SCROLL_DELTA_LINES,
