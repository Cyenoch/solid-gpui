...
- Added a strict `make audit` gate for Bun advisories and cargo-deny, with documented acknowledgements for the three currently unmaintained Rust crates.
...
- Replaced the GPL-licensed ztracing instrumentation dependency with an independently authored no-op proc-macro stub (license blocker mitigation; see license-audit notes).
## [0.2.0] - 2026-08-30
