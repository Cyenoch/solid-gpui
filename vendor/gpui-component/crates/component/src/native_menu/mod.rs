...
impl NativeMenu {
    ...
    pub fn submenu(self, label: impl Into<SharedString>, submenu: NativeMenu) -> Self {
        self.submenu_with_disabled(label, submenu, false)
    }

    /// Append a submenu with an explicit enabled/disabled state.
