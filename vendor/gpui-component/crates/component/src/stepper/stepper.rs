...
pub struct Stepper {
    ...
    items: Vec<ComponentChild<StepperItem>>,
    step: usize,
    layout: Axis,
    disabled: bool,
    size: Size,
...
impl Stepper {
    ...
    pub fn item(mut self, item: impl Into<ComponentChild<StepperItem>>) -> Self {
    ...
    pub fn items(
        mut self,
        items: impl IntoIterator<Item = impl Into<ComponentChild<StepperItem>>>,
    ) -> Self {
