...
pub struct RadioGroup {
    id: ElementId,
    style: StyleRefinement,
    radios: Vec<ComponentChild<Radio>>,
    layout: Axis,
...
impl RadioGroup {
    ...
    pub fn child(mut self, child: impl Into<ComponentChild<Radio>>) -> Self {
    ...
    pub fn children(
        mut self,
        children: impl IntoIterator<Item = impl Into<ComponentChild<Radio>>>,
    ) -> Self {
