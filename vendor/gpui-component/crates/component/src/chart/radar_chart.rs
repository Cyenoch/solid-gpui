...
mod tests {
    ...
    fn test_radar_chart_builder() {
        ...
        assert!(chart.strokes[0].is_some());
        assert!(chart.strokes[1].is_none());
        assert_eq!(chart.fills.len(), 2);
        assert!(chart.fills[0].is_some());
        assert!(chart.fills[1].is_none());
        assert_eq!(chart.names.len(), 2);
        assert!(chart.names[1].is_empty());
