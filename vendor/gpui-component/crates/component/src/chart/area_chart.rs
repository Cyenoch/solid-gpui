    ...
    Y: Clone + Copy + PartialOrd + Num + ToPrimitive + Sealed + 'static,
{
    ...
    y: Vec<Rc<dyn Fn(&T) -> Y>>,
    strokes: Vec<Option<Hsla>>,
    stroke_styles: Vec<StrokeStyle>,
    fills: Vec<Option<Background>>,
    ...
    Y: Clone + Copy + PartialOrd + Num + ToPrimitive + Sealed + 'static,
{
    ...
    pub fn name(mut self, name: impl Into<SharedString>) -> Self {
        *self
            .names
            .last_mut()
            .expect("add a series before naming it") = name.into();
        self
    }
    ...
    pub fn y(mut self, y: impl Fn(&T) -> Y + 'static) -> Self {
        ...
        self.strokes.push(None);
        self.fills.push(None);
        self.names.push(SharedString::default());
        self.stroke_styles.push(StrokeStyle::default());
        self
    }
    ...
    pub fn stroke(mut self, stroke: impl Into<Hsla>) -> Self {
        *self
            .strokes
            .last_mut()
            .expect("add a series before styling it") = Some(stroke.into());
        self
    }
    ...
    pub fn fill(mut self, fill: impl Into<Background>) -> Self {
        *self
            .fills
            .last_mut()
            .expect("add a series before styling it") = Some(fill.into());
        self
    }
    ...
    pub fn natural(mut self) -> Self {
        *self
            .stroke_styles
            .last_mut()
            .expect("add a series before styling it") = StrokeStyle::Natural;
        self
    }
    ...
    pub fn linear(mut self) -> Self {
        *self
            .stroke_styles
            .last_mut()
            .expect("add a series before styling it") = StrokeStyle::Linear;
        self
    }
    ...
    pub fn step_after(mut self) -> Self {
        *self
            .stroke_styles
            .last_mut()
            .expect("add a series before styling it") = StrokeStyle::StepAfter;
        self
    }
