...
impl FpsMonitor {
    /// Choose measured presentation cadence or estimated redraw capacity.
    pub fn frame_rate_mode(mut self, mode: FrameRateMode) -> Self {
        self.headline = mode;
        self
    }
    ...
    pub fn new(window: &Window, _cx: &mut Context<Self>) -> Self {
        ...
        Self {
            ...
            headline: FrameRateMode::Capacity,
            display: None,
            show_resources: true,
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .when(self.headline == FrameRateMode::Capacity, |this| {
                                this.child("MAX")
                            }),
                    )
                    .child(
...
impl Render for FpsMonitor {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let rate = match headline {
            FrameRateMode::Capacity => max_fps,
            FrameRateMode::Observed => fps,
        };
            ...
            .on_mouse_down(
                ...
                cx.listener(|this, _, _, cx| {
                    this.headline = match this.headline {
                        FrameRateMode::Capacity => FrameRateMode::Observed,
                        FrameRateMode::Observed => FrameRateMode::Capacity,
                    };
                    cx.stop_propagation();
                    cx.notify();
                }),
            ...
            .map(|this| {
                if compact {
                    ...
                    this.items_center()
                        ...
                        .py_0p5()
                        .rounded(px(3.))
                        .when(headline == FrameRateMode::Capacity, |this| {
                            this.child("MAX")
                        })
                        .child(
                            div()
