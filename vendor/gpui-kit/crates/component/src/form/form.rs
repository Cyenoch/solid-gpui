...
pub struct Form {
    ...
    fields: Vec<ComponentChild<Field>>,
...
impl Form {
    ...
    pub fn child(mut self, field: impl Into<ComponentChild<Field>>) -> Self {
    ...
    pub fn children(
        mut self,
        fields: impl IntoIterator<Item = impl Into<ComponentChild<Field>>>,
    ) -> Self {
