...
pub struct SidebarMenu {
    ...
    collapsed: bool,
    items: Vec<ComponentChild<SidebarMenuItem>>,
}
...
impl SidebarMenu {
    ...
    pub fn child(mut self, child: impl Into<ComponentChild<SidebarMenuItem>>) -> Self {
    ...
    pub fn children(
        mut self,
        children: impl IntoIterator<Item = impl Into<ComponentChild<SidebarMenuItem>>>,
    ) -> Self {
...
pub struct SidebarMenuItem {
    ...
    children: Vec<ComponentChild<Self>>,
...
impl SidebarMenuItem {
    ...
    /// Stable identity independent of its current position in the menu.
    ...
    pub fn children(
        mut self,
        children: impl IntoIterator<Item = impl Into<ComponentChild<Self>>>,
    ) -> Self {
...
impl SidebarItem for SidebarMenuItem {
    fn render(
        ...
        let id = self.id.clone().unwrap_or_else(|| id.into());
