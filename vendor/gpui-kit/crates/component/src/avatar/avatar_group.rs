...
pub struct AvatarGroup {
    ...
    avatars: Vec<ComponentChild<Avatar>>,
    size: Size,
    limit: usize,
    ellipsis: bool,
}
...
impl AvatarGroup {
    ...
    pub fn child(mut self, avatar: impl Into<ComponentChild<Avatar>>) -> Self {
    ...
    pub fn children(
        mut self,
        avatars: impl IntoIterator<Item = impl Into<ComponentChild<Avatar>>>,
    ) -> Self {
