...
impl Icon {
    ...
    /// Reuse validated, shared SVG storage without copying it during retained rendering.
    pub fn shared_data(mut self, data: Arc<[u8]>) -> Self {
        self.source = IconSource::Data(data);
        self
    }
