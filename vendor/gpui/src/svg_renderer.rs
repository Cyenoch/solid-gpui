// Modified by solid-gpui: use bundled, licensed SVG-test font fixtures.
use crate::{
...
mod tests {
    ...
    const IBM_PLEX_REGULAR: &[u8] =
        include_bytes!("../test-assets/ibm-plex-sans/IBMPlexSans-Regular.ttf");
    const LILEX_REGULAR: &[u8] = include_bytes!("../test-assets/lilex/Lilex-Regular.ttf");
