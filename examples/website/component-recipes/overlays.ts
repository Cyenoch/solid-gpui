  ...
  ...recipes("Notification", [
    {
      ...
      description: "Trigger an in-app message from an explicit action; it leaves on click or after its own timer.",
    ...
    },
    {
      ...
      description: "Offer a relevant follow-up inside the notification; it waits until it is answered or clicked away.",
