  ...
  ...recipes("Marker MarkerContent MarkerIcon", [
    {
      ...
      jsx: '<N.Marker variant="separator"><N.MarkerIcon><N.Icon source="lucide:check" /></N.MarkerIcon><N.MarkerContent text="All changes saved" /></N.Marker>',
      setup: "",
    },
    {
      id: "border",
      title: "Border marker",
      description: "Mark a meaningful event between items in an activity stream.",
      jsx: '<N.Marker variant="border"><N.MarkerIcon><N.Icon source="lucide:check" /></N.MarkerIcon><N.MarkerContent text="All changes saved" /></N.Marker>',
      setup: "",
    },
  ]),
